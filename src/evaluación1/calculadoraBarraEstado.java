...
public class calculadoraBarraEstado extends JFrame implements ActionListener{
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    calculadoraBarraEstado frame = new calculadoraBarraEstado();
    ...
    public calculadoraBarraEstado() {
        ...
        panel_1 = new JPanel();
        panel_1.setBounds(218, 97, 66, 268);
        ...
        panel_3 = new JPanel();
        panel_3.setBounds(175, 97, 43, 268);
        ...
        panelEstado.setBounds(0, 365, 284, 24);
        Contenedor.add(panelEstado);
        
        lblEstado = new JLabel("Estado:");
        panelEstado.add(lblEstado);
        
        lblEstadoActual = new JLabel("Listo");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // si pulsa una cifra
            if(txtNumero.getText().equals("0")) {
                ...
                lblEstadoActual.setText("Operando");
            }
            else {
